...
function toggleLoading(isLoading) {
  ...
  if (!isLoading) {
    search.firstElementChild.setAttribute("class", "fas fa-search");
    search.lastElementChild.innerText = " Search";
    search.disabled = false;
  } else {
    search.firstElementChild.setAttribute("class", "fas fa-hourglass-half");
    search.lastElementChild.innerText = " Loading...";
